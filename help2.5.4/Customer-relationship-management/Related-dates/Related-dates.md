...
>  مسیر دسترسی:  **مدیریت ارتباط با مشتریان** >**تاریخ‌های مرتبط** 
 ...
 تمام ارسال های برنامه ریزی شده و زمانبندی شده برای اجرا که از قسمت تاریخ های مهم پروفایل ها تنظیم می کنید،در قسمت تاریخ های مرتبط در تب مدیریت ارتباط با مشتریان قابل مشاهده است و می توانید با استفاده از فیلترهای مختلف، برنامه مورد نظر خود را جستجو و پیدا کنید.
